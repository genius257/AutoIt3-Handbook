...
## [Basic syntax](basic-syntax/index.md)
* [Instruction separation](basic-syntax/instruction-separation.md)
* [Line continuation](basic-syntax/line-continuation.md)
* [Comments](basic-syntax/comments.md)

## [Types](types/index.md)
* [Introduction](types/introduction.md)
* [Booleans](types/booleans.md)
* [Integers](types/integers.md)
* [Floating point numbers](types/floating-point-numbers.md)
* [Strings](types/strings.md)
* [Arrays](types/arrays.md)
* [Objects](types/objects.md)
* [NULL](types/null.md)
* [Type Juggling](types/type-juggling.md)
